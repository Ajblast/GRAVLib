...
#define GRAVLib_LOCK_MUTEX_IMPL(name) GRAVLib::Concurrency::Locks::scopedLock<GRAVLib_LOCK_TYPE> GRAVLib_ANONYMOUS_VARIABLE(GRAVLibLock) (name)
#define GRAVLib_LOCK_NAMED_MUTEX_IMPL(mutexName, lockName) GRAVLib::Concurrency::Locks::scopedLock<GRAVLib_LOCK_TYPE> lockName(mutexName)
